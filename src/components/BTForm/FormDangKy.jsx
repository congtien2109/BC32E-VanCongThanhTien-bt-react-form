        ...
        <div className="grid grid-cols-2 gap-6 mt-5">
          <div>
            ...
            <input
              ...
              className="border-2 border-gray rounded-sm p-3 w-full mt-2"
          ...
          <div>
            <button
              type="submit"
              className={`p-2 rounded-sm mr-4 bg-green-500 text-white cursor-pointer hover:bg-red-700 ${
            ...
            <button
              type="submit"
              className={`p-2 rounded-sm mr-4 bg-blue-500 text-white cursor-pointer hover:bg-yellow-700 ${
                this.props.selectedUser ?? "hidden"
              }`}
            >
              Cập nhật sinh viên
          ...
          <div>
            <input
              ...
              className="border-2 border-gray mr-10 rounded-sm p-3 w-60"
              onChange={this.handleInput}
            />

            <button
              className="p-2 rounded-sm mr-4 bg-blue-500 text-white cursor-pointer hover:bg-red-700"
